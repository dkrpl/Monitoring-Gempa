    ...
    <div class="col-lg-8">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group">
                    <select class="form-control form-control-sm" id="chartDeviceSelect" onchange="updateChart()">
            ...
            <div class="card-body">
                <div class="list-group" id="recentLogs">
                    <div class="text-center py-3">
                        ...
                        <p class="mt-2 text-muted">Loading recent logs...</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary">All Device Logs</h6>
                <div class="btn-group">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <strong>{{ $log->device->nama_device }}</strong><br>
                ...
                if (data.logs.length === 0) {
                    container.innerHTML = `
                        <div class="text-center py-3">
                            ...
                            <p class="text-muted">No recent logs in the last hour</p>
                        </div>
                    `;
                    return;
                }
                    ...
                    html += `
                        <div class="list-group-item list-group-item-action ${log.status}">
                            ...
                            <p class="mb-1">
                                ...
                                ${log.magnitude !== null ? `<span class="badge badge-${log.magnitude >= 5.0 ? 'danger' : log.magnitude >= 3.0 ? 'warning' : 'success'}">
